...
export default defineComponent({
  ...
  methods: {
    setcrteDetails(crDetails: cr) {
  this.idCr = crDetails.idCr;
...
editCr(cr: cr) {
  console.log('Received cr:', cr);
  this.setcrteDetails(cr);

  if (cr.idCr !== undefined) {
    this.idCr = cr.idCr;
  }

  this.codigoCr = cr.codigoCr;
  this.siglaCr = cr.siglaCr;
  this.nomeCr = cr.nomeCr;
